...
/// if there is a value, it is in fact a String, so the conversion is made by Dart automatically.
///
/// Obviously if filter's value is not a String an error will be thrown.
